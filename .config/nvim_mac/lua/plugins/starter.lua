local plugin = {
  ...
  event = 'VimEnter',
  opts = function()
    local prefix_excludes = { 'a', 't', 'o', 'c', 'e', 'q' }
    ...
    local config = {
      ...
      items = {
        ...
        { action = [[lua require ("orgmode").action('agenda.agenda')]], name = 'a] org-agenda', section = 'Notebook' },
        {
          action = [[lua require ("orgmode").action('capture.prompt')]],
          name = 't] capture task',
          section = 'Notebook',
        },
        {
